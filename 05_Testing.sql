...
EXEC Administracion.Parque_Insertar 'Parque Nacional - Iguazú', 'Misiones', 67700, 'Cataratas', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Los Glaciares', 'Santa Cruz', 726927, 'Hielo frio', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Nahuel Huapi', 'Río Negro y Neuquén', 710000, 'Nahuelito.', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Talampaya', 'La Rioja', 215000, 'Cañones rocosos.', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Lanín', 'Neuquén', 412000, 'Volcán Lanín.', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Tierra del Fuego', 'Tierra del Fuego', 68909, 'Fin del mundo', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - El Palmar', 'Entre Ríos', 8500, 'Palmeras Yatay', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Quebrada del Condorito', 'Córdoba', 37344, 'Avistaje de cóndores', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Los Alerces', 'Chubut', 259570, 'Alerzal milenario', 1, 1;
EXEC Administracion.Parque_Insertar 'Parque Nacional - Sierra de las Quijadas', 'San Luis', 73533, 'Fósiles y huellas', 1, 1;
